...
if __name__ == "__main__":
    # ---- Step 1: create filtered jsonl files (recommended) ----
    # If you already created them once, you can comment this out.
    '''
    ...
    predict_jsonl(
        ...
        tokenizer,
        device,
        input_jsonl="test_no_misc.jsonl",
        output_jsonl="predictions_no_misc_emotionpredicted.jsonl"
    )
