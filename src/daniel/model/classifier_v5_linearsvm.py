...
# -----------------------------
try:
    EXPERIMENT_NAME = Path(__file__).stem  # classifier_v5_svm
except NameError:
    EXPERIMENT_NAME = "classifier_v5_svm"
...
def evaluate_split(name: str, X, y_true):
    ...
    save_confusion_matrix_png(
        ...
        out_path=png_path,
        title=f"Emotion Confusion Matrix (Counts) — {name} (LinearSVC)",
    )
...
# ===============================
model_path      = ARTIFACTS_DIR / "linearsvc_model.joblib"
